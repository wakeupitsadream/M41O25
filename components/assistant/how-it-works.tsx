          ...
          {limits && (
            <Block title="Лимиты">
              ...
              {limits.budget && (
                <>
                  {" "}
                  Ещё есть ресурс на 30 дней: сколько стоят твои ответы. Документы и сильный режим тратят его быстрее, чем короткие вопросы;
                  он возвращается по мере того, как старые вопросы выходят из 30 дней.
                </>
              )}
            </Block>
          )}
