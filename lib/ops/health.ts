...
/**
 * Файл без записи — обычно брошенный крестиком в форме: сутки на «передумал» и в утиль. Вложения помощника
 * ('assistant') живут по этому же сроку: к сообщению они привязываются при отправке, ничейные — из неотправленного
 * композера (docs/AI-CHAT.md §5).
 */
